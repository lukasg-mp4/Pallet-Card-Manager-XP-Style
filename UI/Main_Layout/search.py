...
class SearchDialog(tk.Toplevel):
    def __init__(self, parent, app):
        ...
        # --- STYLE CONFIGURATION (Restore XP Look) ---
        style = ttk.Style()
        style.theme_use('clam') # Required for color customization on headers
        
        # Treeview Content Font
        ...
        # Treeview Header Font (Bold) & Background
        ...
        # 1. Label
        lbl = tk.Label(self.content, text="Type to search (Use Up/Down arrows to select):", 
                       font=XP_FONT, bg=XP_BEIGE, fg="black")
