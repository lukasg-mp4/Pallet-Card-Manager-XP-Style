...
class XPMessageBox(tk.Toplevel):
    def __init__(self, parent, title, message):
        ...
        tk.Button(inner_btn_frame, text="Yes", width=10, command=self.confirm, bg=XP_BTN_BG, relief="raised", bd=2, font=XP_FONT).pack(side=tk.LEFT, padx=15)
        tk.Button(inner_btn_frame, text="No", width=10, command=self.cancel, bg=XP_BTN_BG, relief="raised", bd=2, font=XP_FONT).pack(side=tk.LEFT, padx=15)
